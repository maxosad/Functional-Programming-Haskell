...
happyExpList = Happy_Data_Array.listArray (0,34) ([31744,63488,512,0,0,0,0,0,0,0,0,2,992,40,32,0,15872,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Expr","Args","Value","Fun","'('","')'","','","'add'","'div'","'mul'","'sub'","cnst","fun","%eof"]
        bit_start = st * 17
        bit_end = (st + 1) * 17
...
action_2 (8) = happyShift action_11
...
happyReduction_1 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (HiExprApply happy_var_1 happy_var_3
	) `HappyStk` happyRest

happyReduce_2 = happySpecReduce_1  4 happyReduction_2
happyReduction_2 (HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn4
		 (HiExprValue happy_var_1
	)
...
happyReduction_5 (HappyTerminal (TNum  happy_var_1))
	 =  HappyAbsSyn6
		 (HiValueNumber happy_var_1
	)
